...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'EventLinkChange'
        db.create_table(u'event_eventlinkchange', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('description', self.gf('django.db.models.fields.CharField')(max_length=30)),
        ))
        db.send_create_signal(u'event', ['EventLinkChange'])
    ...
    def backwards(self, orm):
        ...
        # Deleting model 'EventLinkChange'
        db.delete_table(u'event_eventlinkchange')
    ...
    models = {
        ...
        u'event.eventlinkchange': {
            'Meta': {'object_name': 'EventLinkChange'},
