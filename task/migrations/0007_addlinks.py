...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'task_tasklink', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('from_task', self.gf('django.db.models.fields.related.ForeignKey')(related_name='links_out', to=orm['task.Task'])),
            ('to_task', self.gf('django.db.models.fields.related.ForeignKey')(related_name='links_in', to=orm['task.Task'])),
            ('link_type', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['task.TaskLinkType'])),
        ))
        db.send_create_signal(u'task', ['TaskLink'])

        # Adding model 'TaskLinkType'
        db.create_table(u'task_tasklinktype', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'])),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=30)),
            ('from_desc', self.gf('django.db.models.fields.CharField')(max_length=30)),
            ('to_desc', self.gf('django.db.models.fields.CharField')(max_length=30)),
        ))
        db.send_create_signal(u'task', ['TaskLinkType'])


    def backwards(self, orm):
        # Deleting model 'TaskLink'
        db.delete_table(u'task_tasklink')

        # Deleting model 'TaskLinkType'
        db.delete_table(u'task_tasklinktype')
