...
class Migration(SchemaMigration):
    ...
    models = {
        ...
        u'task.eventmemo': {
            ...
            'reply_to': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['task.EventMemo']"})
        },
        u'task.eventrecord': {
        ...
        u'task.eventrecordentry': {
            'Meta': {'object_name': 'EventRecordEntry'},
            'content_type': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['contenttypes.ContentType']"}),
            'event': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['task.EventRecord']"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'object_id': ('django.db.models.fields.PositiveIntegerField', [], {})
        },
        u'task.task': {
