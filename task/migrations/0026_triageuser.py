...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'TriageUser'
        db.create_table(u'task_triageuser', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['auth.User'], unique=True)),
            ('default_due_time', self.gf('django.db.models.fields.TimeField')(null=True, blank=True)),
        ))
        db.send_create_signal(u'task', ['TriageUser'])

    def backwards(self, orm):
        # Deleting model 'TriageUser'
        db.delete_table(u'task_triageuser')
    ...
    models = {
        ...
        u'task.triageuser': {
            'Meta': {'object_name': 'TriageUser'},
            'default_due_time': ('django.db.models.fields.TimeField', [], {'null': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
