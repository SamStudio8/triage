...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'task_task', 'created_by',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='created_tasks', null=True, to=orm['auth.User']),
                      keep_default=False)

        # Adding field 'Task.modified_by'
        db.add_column(u'task_task', 'modified_by',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='modified_tasks', null=True, to=orm['auth.User']),
                      keep_default=False)
    ...
    models = {
        ...
        u'task.task': {
            ...
            'created_by': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'created_tasks'", 'null': 'True', 'to': u"orm['auth.User']"}),
            ...
            'modified_by': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'modified_tasks'", 'null': 'True', 'to': u"orm['auth.User']"}),
