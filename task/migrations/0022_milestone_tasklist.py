...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'TaskMilestone.tasklist'
        db.add_column(u'task_taskmilestone', 'tasklist',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['task.TaskList'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'TaskMilestone.tasklist'
        db.delete_column(u'task_taskmilestone', 'tasklist_id')
