...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'TaskList.order'
        db.add_column(u'task_tasklist', 'order',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)


        # Changing field 'TaskList.name'
        db.alter_column(u'task_tasklist', 'name', self.gf('django.db.models.fields.CharField')(max_length=255))

    def backwards(self, orm):
        # Deleting field 'TaskList.order'
        db.delete_column(u'task_tasklist', 'order')


        # Changing field 'TaskList.name'
        db.alter_column(u'task_tasklist', 'name', self.gf('django.db.models.fields.CharField')(max_length=30))
    ...
    models = {
        ...
        u'task.tasklist': {
            'Meta': {'ordering': "['-order']", 'object_name': 'TaskList'},
