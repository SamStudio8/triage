...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'TaskMilestone.user'
        db.alter_column(u'task_taskmilestone', 'user_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['auth.User']))

    def backwards(self, orm):
        # Changing field 'TaskMilestone.user'
        db.alter_column(u'task_taskmilestone', 'user_id', self.gf('django.db.models.fields.related.ForeignKey')(default=0, to=orm['auth.User']))
    ...
    models = {
        ...
        u'task.taskmilestone': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '30'}),
            'tasklist': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'milestones'", 'null': 'True', 'to': u"orm['task.TaskList']"}),
            'user': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'milestones'", 'null': 'True', 'to': u"orm['auth.User']"})
        },
