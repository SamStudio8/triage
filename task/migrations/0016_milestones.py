...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'TaskMilestone'
        db.create_table(u'task_taskmilestone', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(related_name='milestones', to=orm['auth.User'])),
        ...
        db.send_create_signal(u'task', ['TaskMilestone'])

        # Adding field 'Task.milestone'
        db.add_column(u'task_task', 'milestone',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['task.TaskMilestone'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting model 'TaskMilestone'
        db.delete_table(u'task_taskmilestone')

        # Deleting field 'Task.milestone'
        db.delete_column(u'task_task', 'milestone_id')
