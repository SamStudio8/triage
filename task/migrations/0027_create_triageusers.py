...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        # Create a TriageUser for existing users
        User = orm['auth.User']
        for user in User.objects.all():
            tu = orm.TriageUser(user_id=user.pk)
            tu.save()

    def backwards(self, orm):
        # No backward step required, TriageUsers would be nuked by dropping
        # the table created in migration 0026
        pass
