...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'TaskMilestone.user'
        db.delete_column(u'task_taskmilestone', 'user_id')


    def backwards(self, orm):
        # Adding field 'TaskMilestone.user'
        db.add_column(u'task_taskmilestone', 'user',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=0, related_name='milestones', to=orm['auth.User']),
                      keep_default=False)

        # Restore user id
        for milestone in orm.TaskMilestone.objects.all():
            milestone.user = milestone.tasklist.user
            milestone.save()
