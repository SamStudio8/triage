...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding unique constraint on 'TaskLink', fields ['from_task', 'to_task']
        db.create_unique(u'task_tasklink', ['from_task_id', 'to_task_id'])


    def backwards(self, orm):
        # Removing unique constraint on 'TaskLink', fields ['from_task', 'to_task']
        db.delete_unique(u'task_tasklink', ['from_task_id', 'to_task_id'])
