...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding unique constraint on 'TaskList', fields ['user', 'slug']
        db.create_unique(u'task_tasklist', ['user_id', 'slug'])


    def backwards(self, orm):
        # Removing unique constraint on 'TaskList', fields ['user', 'slug']
        db.delete_unique(u'task_tasklist', ['user_id', 'slug'])
